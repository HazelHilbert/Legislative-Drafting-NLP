...
function getMetricDefinitionsForASpecificInstanceOfAMultiRolePoolOfAnAppServiceEnvironment() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.appServiceEnvironments.listMultiRolePoolInstanceMetricDefinitions(resourceGroupName, name, instance)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
getMetricDefinitionsForASpecificInstanceOfAMultiRolePoolOfAnAppServiceEnvironment().catch(console.error);
