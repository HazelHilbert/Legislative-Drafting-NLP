 ...
 */
function apiManagementGetCertificate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificate.get(resourceGroupName, serviceName, certificateId);
        console.log(result);
    });
}
 ...
 */
function apiManagementGetCertificateWithKeyVault() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "subid";
        const resourceGroupName = "rg1";
        const serviceName = "apimService1";
