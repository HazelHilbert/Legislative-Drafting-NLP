 ...
 */
function apiManagementNamedValueListValue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namedValue.listValue(resourceGroupName, serviceName, namedValueId);
        console.log(result);
    });
}
apiManagementNamedValueListValue().catch(console.error);
//# sourceMappingURL=namedValueListValueSample.js.map