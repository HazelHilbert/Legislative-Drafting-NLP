 ...
 */
function apiManagementRefreshCertificate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.certificate.refreshSecret(resourceGroupName, serviceName, certificateId);
        console.log(result);
    });
}
apiManagementRefreshCertificate().catch(console.error);
//# sourceMappingURL=certificateRefreshSecretSample.js.map