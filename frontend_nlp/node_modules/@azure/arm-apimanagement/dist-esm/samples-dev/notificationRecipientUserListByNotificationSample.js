 ...
 */
function apiManagementListNotificationRecipientUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationRecipientUser.listByNotification(resourceGroupName, serviceName, notificationName);
        console.log(result);
    });
}
apiManagementListNotificationRecipientUsers().catch(console.error);
//# sourceMappingURL=notificationRecipientUserListByNotificationSample.js.map