 ...
 */
function apiManagementDeleteNamedValue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namedValue.delete(resourceGroupName, serviceName, namedValueId, ifMatch);
        console.log(result);
    });
}
apiManagementDeleteNamedValue().catch(console.error);
//# sourceMappingURL=namedValueDeleteSample.js.map