 ...
 */
function apiManagementGetPrivateLinkGroupResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnectionOperations.getPrivateLinkResource(resourceGroupName, serviceName, privateLinkSubResourceName);
        console.log(result);
    });
}
apiManagementGetPrivateLinkGroupResource().catch(console.error);
//# sourceMappingURL=privateEndpointConnectionGetPrivateLinkResourceSample.js.map