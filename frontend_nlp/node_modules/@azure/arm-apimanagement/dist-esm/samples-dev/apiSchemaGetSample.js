 ...
 */
function apiManagementGetApiSchema() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiSchema.get(resourceGroupName, serviceName, apiId, schemaId);
        console.log(result);
    });
}
apiManagementGetApiSchema().catch(console.error);
//# sourceMappingURL=apiSchemaGetSample.js.map