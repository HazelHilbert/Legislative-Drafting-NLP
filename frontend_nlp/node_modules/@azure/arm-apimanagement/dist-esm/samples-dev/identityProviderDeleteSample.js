 ...
 */
function apiManagementDeleteIdentityProvider() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.identityProvider.delete(resourceGroupName, serviceName, identityProviderName, ifMatch);
        console.log(result);
    });
}
apiManagementDeleteIdentityProvider().catch(console.error);
//# sourceMappingURL=identityProviderDeleteSample.js.map