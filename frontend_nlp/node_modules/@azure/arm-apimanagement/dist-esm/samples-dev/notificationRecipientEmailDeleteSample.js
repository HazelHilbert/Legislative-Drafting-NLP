 ...
 */
function apiManagementDeleteNotificationRecipientEmail() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationRecipientEmail.delete(resourceGroupName, serviceName, notificationName, email);
        console.log(result);
    });
}
apiManagementDeleteNotificationRecipientEmail().catch(console.error);
//# sourceMappingURL=notificationRecipientEmailDeleteSample.js.map