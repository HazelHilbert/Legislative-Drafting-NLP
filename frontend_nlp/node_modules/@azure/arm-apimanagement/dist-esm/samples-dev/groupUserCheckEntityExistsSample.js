 ...
 */
function apiManagementHeadGroupUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.groupUser.checkEntityExists(resourceGroupName, serviceName, groupId, userId);
        console.log(result);
    });
}
apiManagementHeadGroupUser().catch(console.error);
//# sourceMappingURL=groupUserCheckEntityExistsSample.js.map