 ...
 */
function apiManagementHeadApiTagDescription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiTagDescription.getEntityTag(resourceGroupName, serviceName, apiId, tagDescriptionId);
        console.log(result);
    });
}
apiManagementHeadApiTagDescription().catch(console.error);
//# sourceMappingURL=apiTagDescriptionGetEntityTagSample.js.map