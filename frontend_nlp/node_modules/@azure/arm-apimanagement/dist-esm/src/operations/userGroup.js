...
export class UserGroupImpl {
    ...
    listPagingPage(resourceGroupName, serviceName, userId, options) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            let result = yield __await(this._list(resourceGroupName, serviceName, userId, options));
    ...
    listPagingAll(resourceGroupName, serviceName, userId, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, serviceName, userId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
