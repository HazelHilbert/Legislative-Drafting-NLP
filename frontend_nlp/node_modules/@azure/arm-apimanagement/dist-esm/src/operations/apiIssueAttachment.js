...
export class ApiIssueAttachmentImpl {
    ...
    listByServicePagingPage(resourceGroupName, serviceName, apiId, issueId, options) {
        return __asyncGenerator(this, arguments, function* listByServicePagingPage_1() {
            let result = yield __await(this._listByService(resourceGroupName, serviceName, apiId, issueId, options));
    ...
    listByServicePagingAll(resourceGroupName, serviceName, apiId, issueId, options) {
        return __asyncGenerator(this, arguments, function* listByServicePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByServicePagingPage(resourceGroupName, serviceName, apiId, issueId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
