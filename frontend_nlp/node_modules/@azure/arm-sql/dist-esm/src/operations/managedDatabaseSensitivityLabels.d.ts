...
export declare class ManagedDatabaseSensitivityLabelsImpl implements ManagedDatabaseSensitivityLabels {
    ...
    private listCurrentByDatabasePagingPage;
    private listCurrentByDatabasePagingAll;
    /**
     * Gets the sensitivity labels of a given database
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
     *                          this value from the Azure Resource Manager API or the portal.
    ...
    private listRecommendedByDatabasePagingPage;
    private listRecommendedByDatabasePagingAll;
    /**
...
//# sourceMappingURL=managedDatabaseSensitivityLabels.d.ts.map