...
function plannedFailoverOfAFailoverGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.instanceFailoverGroups.beginFailoverAndWait(resourceGroupName, locationName, failoverGroupName);
        console.log(result);
    });
}
plannedFailoverOfAFailoverGroup().catch(console.error);
//# sourceMappingURL=instanceFailoverGroupsFailoverSample.js.map