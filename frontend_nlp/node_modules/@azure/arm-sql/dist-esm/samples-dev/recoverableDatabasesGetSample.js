 ...
 */
function getARecoverableDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.recoverableDatabases.get(resourceGroupName, serverName, databaseName);
        console.log(result);
    });
}
getARecoverableDatabase().catch(console.error);
//# sourceMappingURL=recoverableDatabasesGetSample.js.map