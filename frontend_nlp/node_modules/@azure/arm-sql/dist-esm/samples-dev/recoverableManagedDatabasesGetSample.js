 ...
 */
function getsARecoverableDatabasesByManagedInstances() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.recoverableManagedDatabases.get(resourceGroupName, managedInstanceName, recoverableDatabaseName);
        console.log(result);
    });
}
getsARecoverableDatabasesByManagedInstances().catch(console.error);
//# sourceMappingURL=recoverableManagedDatabasesGetSample.js.map