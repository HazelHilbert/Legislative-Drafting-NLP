 ...
 */
function updatesTheSensitivityLabelOfAGivenColumnWithAllParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.sensitivityLabels.createOrUpdate(resourceGroupName, serverName, databaseName, schemaName, tableName, columnName, parameters);
        console.log(result);
    });
}
updatesTheSensitivityLabelOfAGivenColumnWithAllParameters().catch(console.error);
//# sourceMappingURL=sensitivityLabelsCreateOrUpdateSample.js.map