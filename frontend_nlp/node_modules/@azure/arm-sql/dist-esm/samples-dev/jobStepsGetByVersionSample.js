 ...
 */
function getTheSpecifiedVersionOfAJobStep() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.jobSteps.getByVersion(resourceGroupName, serverName, jobAgentName, jobName, jobVersion, stepName);
        console.log(result);
    });
}
getTheSpecifiedVersionOfAJobStep().catch(console.error);
//# sourceMappingURL=jobStepsGetByVersionSample.js.map