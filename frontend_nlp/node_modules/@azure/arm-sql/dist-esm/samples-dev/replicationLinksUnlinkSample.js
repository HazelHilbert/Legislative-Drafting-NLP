 ...
 */
function deleteReplicationLink() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.replicationLinks.beginUnlinkAndWait(resourceGroupName, serverName, databaseName, linkId, parameters);
        console.log(result);
    });
}
deleteReplicationLink().catch(console.error);
//# sourceMappingURL=replicationLinksUnlinkSample.js.map