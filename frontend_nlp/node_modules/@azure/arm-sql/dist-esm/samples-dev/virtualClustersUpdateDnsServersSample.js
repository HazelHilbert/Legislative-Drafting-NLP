 ...
 */
function synchronizesTheDnsServerSettingsUsedByTheManagedInstancesInsideTheGivenVirtualCluster() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualClusters.updateDnsServers(resourceGroupName, virtualClusterName);
        console.log(result);
    });
}
synchronizesTheDnsServerSettingsUsedByTheManagedInstancesInsideTheGivenVirtualCluster().catch(console.error);
