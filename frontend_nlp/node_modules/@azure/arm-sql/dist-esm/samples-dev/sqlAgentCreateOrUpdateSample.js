 ...
 */
function putsNewSqlAgentConfigurationToInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.sqlAgent.createOrUpdate(resourceGroupName, managedInstanceName, parameters);
        console.log(result);
    });
}
putsNewSqlAgentConfigurationToInstance().catch(console.error);
//# sourceMappingURL=sqlAgentCreateOrUpdateSample.js.map