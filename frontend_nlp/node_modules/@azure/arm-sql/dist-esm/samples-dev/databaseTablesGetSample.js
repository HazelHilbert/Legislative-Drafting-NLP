...
function getDatabaseTable() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.databaseTables.get(resourceGroupName, serverName, databaseName, schemaName, tableName);
        console.log(result);
    });
}
getDatabaseTable().catch(console.error);
//# sourceMappingURL=databaseTablesGetSample.js.map