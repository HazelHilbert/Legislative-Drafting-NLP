 ...
 */
function generateASyncAgentKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.syncAgents.generateKey(resourceGroupName, serverName, syncAgentName);
        console.log(result);
    });
}
generateASyncAgentKey().catch(console.error);
//# sourceMappingURL=syncAgentsGenerateKeySample.js.map