...
function deletesAzureActiveDirectoryOnlyAuthenticationObject() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedInstanceAzureADOnlyAuthentications.beginDeleteAndWait(resourceGroupName, managedInstanceName, authenticationName);
        console.log(result);
    });
}
deletesAzureActiveDirectoryOnlyAuthenticationObject().catch(console.error);
//# sourceMappingURL=managedInstanceAzureAdOnlyAuthenticationsDeleteSample.js.map