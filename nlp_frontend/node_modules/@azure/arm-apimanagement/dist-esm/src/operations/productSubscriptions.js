...
export class ProductSubscriptionsImpl {
    /**
    ...
    listPagingPage(resourceGroupName, serviceName, productId, options) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            let result = yield __await(this._list(resourceGroupName, serviceName, productId, options));
    ...
    listPagingAll(resourceGroupName, serviceName, productId, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, serviceName, productId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
