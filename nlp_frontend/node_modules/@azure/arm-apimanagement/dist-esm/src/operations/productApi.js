...
export class ProductApiImpl {
    ...
    checkEntityExists(resourceGroupName, serviceName, productId, apiId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, productId, apiId, options }, checkEntityExistsOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, serviceName, productId, apiId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, productId, apiId, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serviceName, productId, apiId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, productId, apiId, options }, deleteOperationSpec);
    }
    /**
     * ListByProductNext
     * @param resourceGroupName The name of the resource group.
