 ...
 */
function apiManagementDeleteGatewayCertificateAuthority() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.gatewayCertificateAuthority.delete(resourceGroupName, serviceName, gatewayId, certificateId, ifMatch);
        console.log(result);
    });
}
apiManagementDeleteGatewayCertificateAuthority().catch(console.error);
//# sourceMappingURL=gatewayCertificateAuthorityDeleteSample.js.map