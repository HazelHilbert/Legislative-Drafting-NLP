...
function apiManagementCreateApiPolicyNonXmlEncoded() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const parameters = {
            format: "rawxml",
            value: '<policies>     <inbound>     <base />  <set-header name="newvalue" exists-action="override">   <value>"@(context.Request.Headers.FirstOrDefault(h => h.Ke=="Via"))" </value>    </set-header>  </inbound>      </policies>'
        };
        const options = { ifMatch };
        const credential = new DefaultAzureCredential();
        const client = new ApiManagementClient(credential, subscriptionId);
