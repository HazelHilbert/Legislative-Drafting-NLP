...
function createsOrUpdatesAzureActiveDirectoryOnlyAuthenticationObject() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedInstanceAzureADOnlyAuthentications.beginCreateOrUpdateAndWait(resourceGroupName, managedInstanceName, authenticationName, parameters);
        console.log(result);
    });
}
createsOrUpdatesAzureActiveDirectoryOnlyAuthenticationObject().catch(console.error);
//# sourceMappingURL=managedInstanceAzureAdOnlyAuthenticationsCreateOrUpdateSample.js.map