...
function getAnElasticPool() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.elasticPools.get(resourceGroupName, serverName, elasticPoolName);
        console.log(result);
    });
}
getAnElasticPool().catch(console.error);
//# sourceMappingURL=elasticPoolsGetSample.js.map