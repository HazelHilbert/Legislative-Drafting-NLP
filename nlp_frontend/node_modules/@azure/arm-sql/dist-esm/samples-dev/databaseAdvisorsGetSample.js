...
function getDatabaseAdvisor() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.databaseAdvisors.get(resourceGroupName, serverName, databaseName, advisorName);
        console.log(result);
    });
}
getDatabaseAdvisor().catch(console.error);
//# sourceMappingURL=databaseAdvisorsGetSample.js.map